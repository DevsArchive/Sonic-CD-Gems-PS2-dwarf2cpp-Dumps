...
_anon0 pata00;
_anon0* patbase_kuzure_a[1];
unsigned char tbla00[22];
unsigned char* tbla[1];
_anon0 patc00;
_anon0 patc01;
_anon0 patc02;
_anon0 patc03;
...
_anon0 patb00;
_anon0 patb01;
_anon0* patbase_kuzure_b[2];
unsigned char tblb00[10];
unsigned char tblb01[10];
